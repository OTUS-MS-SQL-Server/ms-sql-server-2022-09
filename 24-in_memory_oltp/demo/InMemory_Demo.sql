...
DROP TABLE IF EXISTS Sales.OrdersMem2;

Create table Sales.OrdersMem2
([OrderLineID] [int] NOT NULL,
	[OrderID] [int] NOT NULL,
	[StockItemID] [int] NOT NULL,
	[Quantity] [int] NOT NULL,
	CONSTRAINT [PK_Sales_OrderLinesMO2] PRIMARY KEY NONCLUSTERED 
	(
		[OrderLineID] ASC
...
DROP PROCEDURE IF EXISTS Sales.OrdersMem2_Insert;
GO

CREATE PROCEDURE Sales.OrdersMem2_Insert
    @rowcount INT 
  WITH NATIVE_COMPILATION, SCHEMABINDING 
  AS   
  BEGIN ATOMIC   
